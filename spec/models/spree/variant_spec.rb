...
describe Spree::Variant do
  it 'can put a variant on a standard sale' do
    ...
    variant.put_on_sale(value: 10.95)
  ...
  it 'changes the price for each specific currency' do
    ...
    variant.prices.each do |p|
      variant.put_on_sale(value: 10.95, currencies: [ p.currency ])
  ...
  context 'with a valid sale' do
    before(:each) do
      @variant = create(:multi_price_variant)
      @variant.put_on_sale(value: 10.95) # sale is started and enabled at this point for all currencies
    end
